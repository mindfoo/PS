...
const sampleWorkflows = [
  { id: 'wf1', name: 'Pipeline A', ownerId: 'u1', ownerUsername: 'alice', lastRunStatus: 'SUCCESS', isPrivate: false },
  { id: 'wf2', name: 'Nightly Job', ownerId: 'u1', ownerUsername: 'alice', lastRunStatus: null, isPrivate: false },
]

vi.mock('../../contexts/AuthContext', () => ({
  useAuth: () => ({ user: { id: 'u1', username: 'alice', role: 'WRITER' }, loading: false }),
  usePermissions: () => ({
    canReadWorkflows: true, canWriteWorkflows: true, canDeleteWorkflows: true,
    canExecuteWorkflows: true, isReader: false,
  }),
}))
